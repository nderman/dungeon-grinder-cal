...
const ABILITIES := {
	...
	"scrap_bomb": {"name": "Scrap Bomb", "kind": "skill", "scale": "DEX", "mana_cost": 0.0, "cooldown": 3.5, "effect": "nova", "power": 1.1, "radius": 160.0, "description": "Lob a junk charge that detonates around you."},
}
